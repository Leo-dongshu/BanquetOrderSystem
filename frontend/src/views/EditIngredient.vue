  ...
  <div class="edit-ingredient">
    <el-card>
      ...
      <div class="edit-ingredient-content">
        <el-form :model="ingredientForm" label-width="120px" @submit.prevent="updateIngredient">
          ...
          <el-form-item>
            <div class="form-actions">
              <el-button type="primary" native-type="submit" :loading="loading">更新配料</el-button>
...
onMounted(async () => {
  ...
  if (ingredientId) {
    await ingredientStore.fetchIngredientById(ingredientId);
    const ingredient = ingredientStore.currentIngredient;
    if (ingredient) {
...
const updateIngredient = async () => {
  ...
  try {
    ...
    await ingredientStore.updateIngredient(ingredientId, ingredientData);
